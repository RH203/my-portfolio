...
export default function AboutMe() {
  return (
    <Card className="w-10/12 mx-auto my-16 bg-white dark:bg-gray-300 shadow-xl text-gray-900 p-10 grid grid-rows-1">
      <div className="grid lg:grid-cols-3 md:grid-cols-2 ">
        ...
        <div className="flex lg:justify-start lg:items-start flex-col col-span-2 my-auto ml-5 gap-8 md:justify-center md:items-center">
          <div>
            <header>
              <h3 className="font-bold text-6xl font-poppins">Welcome to</h3>
            </header>
